...
/**
 * This class stands for getMissionsFrequencyResponse StructType
 * @subpackage Structs
 */
class GetMissionsFrequencyResponse extends AbstractStructBase
{
    /**
     * The return
    ...
    public $return;
    /**
     * Constructor method for getMissionsFrequencyResponse
     * @uses GetMissionsFrequencyResponse::setReturn()
     ...
     * @param \StructType\WrMissions $return
     * @return \StructType\GetMissionsFrequencyResponse
     */
