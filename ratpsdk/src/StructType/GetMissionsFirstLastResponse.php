...
/**
 * This class stands for getMissionsFirstLastResponse StructType
 * @subpackage Structs
 */
class GetMissionsFirstLastResponse extends AbstractStructBase
{
    /**
     * The return
    ...
    public $return;
    /**
     * Constructor method for getMissionsFirstLastResponse
     * @uses GetMissionsFirstLastResponse::setReturn()
     ...
     * @param \StructType\WrMissions $return
     * @return \StructType\GetMissionsFirstLastResponse
     */
